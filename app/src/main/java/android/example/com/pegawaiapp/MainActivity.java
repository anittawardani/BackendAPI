package android.example.com.pegawaiapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    //membaca data json
    private void showExployee(){

        ArrayList<HashMap<String, String>> list
                =new ArrayList<>();
        try {
            JSONObject jsonObject=new JSONObject(JSON_STRING);
            Log.d("CEK_OBJECT_JSON", "onPostExecute: "+jsonObject.getString("result"));
            ...
            for (int i=0;i<result.length();i++){
                ...
                Log.d("NAMA_RESULT", "showExployee: "+jo.getString(konfigurasi.TAG_NAME));
            ...
            Log.d("JSON_ERROR", "showExployee: "+e);
            e.printStackTrace();
        }
